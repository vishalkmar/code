        ...
        <div className="row d-flex justify-content-center">
          ...
          <div className="col-12 col-md-6 col-lg-3 mb-4">
            ...
            <p className="text-white">
              We are a leading software development company delivering innovative solutions since 2015. Our team of 300+ professionals creates digital experiences that drive business growth.
            </p>
          ...
          <div className="col-12 col-md-6 col-lg-4 mb-4">
            ...
            <ul className="list-unstyled">
              <li className="mb-3 d-flex align-items-start">
                ...
                <span className="text-white">vk722413@gmail.com</span>
              </li>
              <li className="mb-3 d-flex align-items-start">
              ...
              <li className="mb-3 d-flex align-items-start">
                ...
                <span className="text-white">123 Tech Park, Sector 22, Noida, India - 201301</span>
              </li>
            </ul>
          </div>
        </div>
